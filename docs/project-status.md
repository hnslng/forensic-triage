...
Stand: **10. September 2026**, Anwendung **v0.2.0-alpha.44**. Einstellungen für Stichwortprofile und Dateitypen sind implementiert. Eigene Profile und Kataloge liegen außerhalb der Release-Verzeichnisse; jeder neue Scan speichert den verwendeten Katalogstand. Der Alpha-44-Update- und Praxistest auf dem Pi steht noch aus. Einzelheiten: [Einstellungen](settings.md).
...
|---|---|---|
| Raspberry Pi 3B+ | Installiert und im Testbetrieb; Alpha 43 wurde zuletzt praktisch auf dem Pi verwendet. | Alpha 44 aktualisieren und prüfen; reproduzierbare Neuinstallation, finaler Speicher-/Stromaufbau und Dauerbetrieb. |
...
| Updates | Prüfung und bewusste Installation praktisch verwendet; Fallende im Updatefenster seit Alpha 43. Alpha 44 trennt Einstellungen vom Release und übernimmt ältere Profile beim ersten Start. | Erhalt eigener Einstellungen beim realen Pi-Update/Rückwechsel sowie vollständige Fehler-/Stromausfallprüfung und Wiederherstellung aller veränderten Komponenten. |
...
- **111 Python-Tests:** für Alpha 44 erfolgreich; decken Scannerbausteine, Fallablage, Zählung, Archivstatus sowie Validierung, Migration, Konflikterkennung und Scan-Snapshots der Einstellungen ab.
- **26 isolierte Browsertests:** für Alpha 44 erfolgreich. Sie nutzen synthetische API-Antworten und prüfen zusätzlich Einstellungen, Dialogwechsel und schmale Ansichten.
...
Für Alpha 44 wurden keine neuen realen Scans, Stromunterbrechungen oder Wiederherstellungen ausgeführt. Neue Messwerte gehören mit Version, Aufbau, Testbestand und Abweichungen in einen datierten Nachweis; echte Falldaten bleiben außerhalb von Git.

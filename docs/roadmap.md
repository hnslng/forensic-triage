...
Dokumentationsstand: 10. September 2026 · Anwendung: `v0.2.0-alpha.46`.
...
- [x] Pi-Unterspannung/Drosselung aktuell und seit Boot sichtbar machen; Zustandsänderungen im Systemjournal protokollieren (Alpha 46).
- [x] Neustart und Herunterfahren zweistufig bestätigen und während Fall, Scan oder Update serverseitig sperren (Alpha 46).

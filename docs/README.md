...
Die Paketversion steht in `pyproject.toml` und `src/forensic_triage/__init__.py`. Für Version 0.2.0-alpha.32 lautet die Python-Version gemäß PEP 440 `0.2.0a32`; der Git-Tag lautet `v0.2.0-alpha.32`.
